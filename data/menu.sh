...
sleep 2
wget -q -O /root/update.sh "https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/update.sh" && chmod +x /root/update.sh
sleep 2
/root/./update.sh
rm /root/update.sh
#rm /opt/.ver
...
echo -e "$COLOR1 $NC ${WH}Client Name ${COLOR1}: ${WH}https://t.me/fv_stores/ 🇮🇩${NC}"
