...
echo ""
wget -q https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/insshws.sh && chmod +x insshws.sh && ./insshws.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/ohp.sh && chmod +x ohp.sh && ./ohp.sh
#Install AutoBackup
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/set-br.sh && chmod +x set-br.sh && ./set-br.sh
#Download Extra Menu
echo -e "${tyblue}.------------------------------------------.${NC}"
echo -e "${tyblue}|           DOWNLOAD EXTRA MENU            |${NC}"
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/update.sh && chmod +x update.sh && ./update.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/FadlyNotNot/myvpn/main/data/version  )
